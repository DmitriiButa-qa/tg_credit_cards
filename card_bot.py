...
bot = TeleBot(token='5973074092:AAGkKvHWbDXumOLCpolyfigc_DLx5diJJMg', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я умею генерировать данные тестовой банковской карты\nВыбери тип карты:', # текст сообщения
